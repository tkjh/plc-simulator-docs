...
The state to the left link is copied to the right link if the state of the associated boolean variable is **TRUE**. Otherwise, the state of the right link is **FALSE**.
...
The state to the right link is TRUE from one evaluation of this element to the next when a transition of the associated boolean variable from
...
The state ot the left link is copied to the right link if the state of the associated Boolean variable is indicated by or. Otherwise, the state of the right link is OFF.
